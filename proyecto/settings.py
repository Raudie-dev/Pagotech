...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Nueva carpeta

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Solo una vez
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': 'logs/pagotech.log',  # Carpeta logs/ en la raíz del proyecto
            'formatter': 'verbose',
            'encoding': 'utf-8',
        },
    },
